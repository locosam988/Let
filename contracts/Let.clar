;; contract-solver
;; Short, unique, error-free Clarity contract
...
;; Submit a solution
(define-public (submit-solution (id uint) (solution (string-ascii 80)))
...
;; Approve project and obtain contract
          ...
          (begin
            (map-set projects id
              ((owner (get owner project))
               ...
               (status "contracted")))
            (ok "Contract awarded successfully")
          )
